    ...
    <main class="container container-sm container-md container-lg container-xl container-xxl">
        ...
        <section class="bg-white card shadow rounded-4 border-0 mb-5">
            <div class="card-header bg-transparent d-flex align-items-center border-0">
                ...
                <a href="category-create.php" class="d-flex align-items-center btn btn-light border ms-auto rounded-5">
                ...
                <table class="table table-card m-0 font-12">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <?php if(f::is_admin()): ?>
                            <th class="border-bottom text-uppercase text-muted" scope="col">Editable</th>
                    ...
                    <tbody class="font-12">
                        ...
                        <tr>
                            <td class="align-middle px-4" data-label="Name">
                                <a href="category-details.php?id=<?php echo $item["id"]; ?>" class="fw-bold link-dark font-14 text-decoration-none">
                                    <?php echo $item["name"]; ?>
                                </a>
                                <div class="d-flex align-items-center m-0 mt-2">
                                    <a href="category-update.php?id=<?php echo $item["id"]; ?>" class="text-decoration-none text-success me-1">Edit</a>
                                    <b>-</b>
                                    <a href="categories.php?id=<?php echo $item["id"]; ?>&action=delete" class="text-decoration-none text-danger mx-1">Delete</a>
                                    <b>-</b>
                                    <p class="ms-1 m-0"><?php echo f::is_active($item['is_active']); ?></p>
                                </div>
                            </td>
                            <?php if(f::is_admin()): ?>
                            <td class="align-middle" data-label="Editable">
                                <?php echo f::is_status($item['is_editable']); ?>
                            </td>
