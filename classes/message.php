	...
	public static function get()
	{
		...
		if (isset($_SESSION["message"])) {
			...
			if ($_SESSION["messagetype"] == "success") {
				$message = '
				<div class="alert alert-success alert-dismissible rounded-5 shadow-sm mb-4 m-0">
					<button type="button" class="btn-close" data-bs-dismiss="alert"></button>
					<strong>Congratulation:</strong> ' . $_SESSION["message"] . '
				</div>';
			} else if ($_SESSION["messagetype"] == "error") {
				$message = '
				<div class="alert alert-danger alert-dismissible rounded-5 shadow-sm mb-4 m-0">
					<button type="button" class="btn-close" data-bs-dismiss="alert"></button>
