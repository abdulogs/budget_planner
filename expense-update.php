...
<head>
    ...
    <title>Expense update - Dashboard</title>
    <!-- Common css -->
    ...
    <main class="container container-sm container-md container-lg container-xl container-xxl">
        ...
        <form class="card col-sm-4 mx-auto shadow border-0 rounded-4" method="post">
                ...
                <div class="row">
                    <div class="form-group mb-3 col-sm-6">
                        ...
                        <select name="category_id" required class="form-select shadow-none border form-control-lg font-14" required>
                            ...
                            <option value="<?php echo $option["id"]; ?>" <?php echo f::selected($option["id"], $data["category_id"]) ?>>
                    ...
                    <div class="form-group mb-3 col-sm-6">
                        ...
                        <select name="budget_id" required class="form-select shadow-none border form-control-lg font-14" required>
                            ...
                            <option value="<?php echo $option["id"]; ?>" <?php echo f::selected($option["id"], $data["budget_id"]) ?>>
                                <?php echo $option["name"]; ?>
                            </option>
                            <?php endforeach;?>
                        </select>
                    ...
                    <div class="form-group mb-3 col-sm-12">
                        ...
                        <textarea class="form-control form-control-lg shadow-none border font-14" name="description"><?php echo $data["description"]; ?></textarea>
                    </div>
                    <div class="form-group mb-3 col-sm-6">
                        <label class="fw-bold mb-0 font-14" for="amount">Amount (PKR)</label>
                        <input type="number" class="form-control form-control-lg shadow-none border font-14" value="<?php echo $data["amount"]; ?>" name="amount" required/>
                    </div>
                    <div class="form-group mb-3 col-sm-6">
            ...
            <div class="card-footer border-top bg-transparent text-center">
                <a href="expenses.php" class="btn btn-light font-14 px-5 rounded-5 border fw-bold">Go back</a>
