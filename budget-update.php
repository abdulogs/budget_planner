...
<head>
    ...
    <title>Budget update - Dashboard</title>
    <!-- Common css -->
    ...
    <main class="container container-sm container-md container-lg container-xl container-xxl">
        ...
        <form class="card col-sm-4 mx-auto shadow border-0 rounded-4" method="post">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group mb-3 col-sm-6">
                        <label class="fw-bold mb-0 font-14" for="budget">Budget (PKR)</label>
                        <input class="form-control form-control-lg shadow-none border font-14" name="budget" value="<?php echo $data["budget"]; ?>" required/>
                    </div>
                    <div class="form-group mb-3 col-sm-6">
                        <label class="fw-bold mb-0 font-14" for="savings">Savings (PKR)</label>
                        <input class="form-control form-control-lg shadow-none border font-14" name="savings" value="<?php echo $data["savings"]; ?>" required/>
                    </div>
            ...
            <div class="card-footer border-top bg-transparent text-center">
                <a href="budgets.php" class="btn btn-light font-14 px-5 rounded-5 border fw-bold">Go back</a>
