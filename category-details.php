        ...
        <div class="card col-sm-4 mx-auto shadow border-0 rounded-4">
            ...
            <div class="card-body">
                <table class="table table-sm font-14 m-0">
                    ...
                    <?php if(f::is_admin()): ?>
                    <tr>
                        <td  class="border-0"><b>Editable</b></td>
                        <td  class="border-0"><?php echo f::is_status($data["is_editable"]); ?></td>
                    </tr>
                    <?php endif; ?>
                    <tr>
            ...
            <div class="card-footer border-top text-center bg-transparent">
                <a href="categories.php" class="btn btn-light font-14 px-5 rounded-5 border fw-bold">Go back</a>
            </div>
        </div>
    </main>
