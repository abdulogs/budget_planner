...
<head>
    ...
    <title>Expense details - Dashboard</title>
    <!-- Common css -->
        ...
        <div class="card col-sm-4 mx-auto shadow border-0 rounded-4">
            ...
            <div class="card-body">
                <table class="table table-sm font-14 m-0">
                    ...
                    <tr>
                        <td class="border-0"><b>Amount</b></td>
                        <td class="border-0"><?php echo $data["amount"]; ?> PKR</td>
                    </tr>
                    <tr>
                        <td class="border-0"><b>Category</b></td>
                        <td class="border-0"><?php echo $data["category"]; ?></td>
                    </tr>
                    <tr>
                        <td class="border-0"><b>Budget</b></td>
                        <td class="border-0"><?php echo $data["budget"]; ?></td>
                    </tr>
                    <tr>
